...
- Create `corpus_data` under `MyDrive`
- Put `ICNALE` corpus under `MyDrive/corpus_file`
...
![xcomp](../../assets/session-11/xcomp.png)


## Example 2

![conj](../../assets/session-11/conj.png)
...
- Open [the Python notebook](https://drive.google.com/file/d/1Kw6nX4xSNiRzz_Kh_TfWlJdL1BhITV_9/view?usp=drive_link)
...
- [Google Colab Notebook](https://drive.google.com/file/d/1tGGp4fHOPYnUoOJbmmAHtzL2VWFG-mjD/view?usp=drive_link)
