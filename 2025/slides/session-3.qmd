...
1. [x] Verbalize your wonder
2. [x] Formulate research questions  
3. [x] Formulate hypothesis
4. [x] Choose appropriate corpus
5. **→ Operationalize** 
6. **→ Test & Evaluate** 
...
|----|----|----|----|
| Common noun   | NOUN | N | `run_NOUN` |
| Proper Nouns  | NAME | NP | `Sendai_NAME` |
| All nouns  | NOUN+ | N+ | `sun_NOUN+`, `Sendai_NOUN+` |
| Lexical verbs | VERB | V | `run_VERB` |
| All verbs | VERB+ | V | `run_VERB+`, `do_VERB+` |
...
1. All forms of the adjective "exciting"
2. The word "chair" as a noun only
...
Search "XXXX" (lemma) and sort by:
1. R1 (what follows "XXXX"?)
2. L1 (what precedes "XXXX"?)
