...
| Lexicalized sentence stems | A conventional expression in whih some elements are fixed and others allow for a range of possibilities |  ** |
...
- Which of the following type of MWUs are more challenging to identify from the frequency-based approach?
  ...
  - Binomials: `by and large`, `black and white`
...
- lengths of each text in corpuss
...
- As collocation is about "preferences based on conventional uses", or more precisely, 
